...
int main(){
	...
	char rootOutputFileName1[50] = "InvarientMassHist_MC_wjets.root"; //Name of an output root file 
	char rootOutputFileName2[50] = "PosVNegPrime_MC_wjets.root"; //Name of an output root file
	char rootOutputFileName3[50] = "PosVNeg_MC_wjets.root"; //Name of an output root file
	char rootOutputFileName4[50] = "MuonIso_MC_wjets.root"; //Name of an output root file
	char rootOutputFileName5[50] = "MET_WMuonMass_MC_wjets.root";
	...
	//NEntries1 = NEntries1/12; //Cut for testing
