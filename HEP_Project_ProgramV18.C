...
int main(){
	...
	char rootOutputFileName1[50] = "Pres_InvariantMassHist.root"; //Name of an output root file 
	char rootOutputFileName2[50] = "Pres_PosVNegPrime.root"; //Name of an output root file
	char rootOutputFileName3[50] = "Pres_PosVNeg.root"; //Name of an output root file
	char rootOutputFileName4[50] = "Pres_MuonIso_btag.root"; //Name of an output root file
	char rootOutputFileName5[50] = "Pres_MET_WMuonMass.root";
	char rootOutputFileName6[50] = "Pres_TransverseMassHist.root";
	char rootOutputFileName7[50] = "Pres_InvariantMassHist_TOP.root";
	char rootOutputFileName8[50] = "Pres_InvariantMassHist_W.root";
	char rootOutputFileName9[50] = "Pres_MuonIsoVsPt.root";
	char rootOutputFileName10[50] = "Pres_InvariantMassHist_Z.root";
	char rootOutputFileName11[50] = "Pres_InvariantMassHist_TOP_Comparison.root";
	char rootOutputFileName12[50] = "Pres_InvariantMassHist_WComparison.root";
	char rootOutputFileName13[50] = "Pres_InvariantMassHist_qJet.root";
	char rootOutputFileName14[50] = "Pres_histM_WHadVsM_TopHad.root";
	...
	TH1F *histM_Muon = new TH1F("histM_Muon", "Invariant Mass hist: Z", 60 , 60, 120);
	...
	TH1F *histM_TopPos = new TH1F("histM_TopPos", "Transverse Mass hist: TopPos", 50, 0, 500);
	TH1F *histM_TopNeg = new TH1F("histM_TopNeg", "Transverse Mass hist: TopNeg", 50, 0, 500);
	TH1F *histM_Top = new TH1F("histM_Top", "Transverse Mass hist: Top", 50, 0, 500);
	TH1F *histM_Top_ZCut = new TH1F("histM_Top_ZCut", "Transverse Mass hist: Top (ZCut)", 50, 0, 500);
	
	
	TH1F *histM_WPos = new TH1F("histM_WPos", "Invariant Mass hist: WPos", xNChannels, 0, 200);
	TH1F *histM_WNeg = new TH1F("histM_WNeg", "Invariant Mass hist: WNeg", xNChannels, 0, 200);
	TH1F *histM_W = new TH1F("histM_W", "Invariant Mass hist: W", xNChannels, 0, 200);
	...
	TH1F *histM_Z = new TH1F("histM_Z", "Invariant Mass hist: Z", 50 , 0, 500);
	
	TH1F *histM_WHad = new TH1F("histM_WHad", "Invariant Mass hist: W Hadronic", 50, 0, 500);
	TH1F *histM_TopHad = new TH1F("histM_TopHad", "Invariant Mass hist: Top Hadronic", 50, 0, 500);
			...
			for(int jet = 0; jet < NJet; jet++){  
				if(Jet_ID[jet] && (Jet_btag[jet] > Jet_btag_Bound)){
					...
					if(D >= 0){
					  ...
					  Top = W + bJet;
					  histM_Top->Fill(Top.M(), EventWeight);
	...
	TCanvas *c7 = new TCanvas("c7","Transverse Mass Top Histrogram" ,200,10,900,700);
		...
		gStyle->SetOptStat(1);
			...
			//c7->cd(1);
			gPad->SetLogy();
			histM_Top->SetXTitle("Transverse Mass");
	...
	TCanvas *c10 = new TCanvas("c10","InvarientMass Z Histrogram" ,200,10,900,700);
		...
		if(FitInvarientMassHist){
			...
			// c10->cd(2);
			gPad->SetLogy();
			histM_Z->SetXTitle("Invarient Mass");
